...
const ScatterPlotTestsCases: React.FC<ScatterPlotTestsCasesProps> = ({
	data,
}) => {
	...
	const scatterOptions: ChartOptions<"scatter"> = {
		...
		scales: {
			x: {
				title: {
					display: true,
					text: t("data_visualization.label_scatter_test"),
				},
				ticks: {
			...
			y: {
				title: {
					display: true,
					text: t("data_visualization.label_scatter_cases"),
				},
				ticks: {
					callback: (v: number | string) =>
						typeof v === "number" ? v.toLocaleString() : v,
